...
const RoundTwo = () => {
  ...
  return (
    <>
      <Head>
        <title>Add Evening Round Two: Meghalaya Teer Result</title>
        <meta
          name="description"
          content="Add round two data for Evening Meghalaya Teer results and explore common number analysis. Stay informed with frequently occurring numbers in the teer game."
        />
        <meta
          name="keywords"
          content="teer, meghalaya teer, teer result, teer result history, teer result archive, common number analysis, add round two, evening teer result"
        />
        <meta name="author" content="Meghalaya Teer Result Archive" />
        <meta
          property="og:title"
          content="Add Evening Round Two: Meghalaya Teer Result"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.meghalayasundayteer.com/common-number-eve/round-2"
        />
      </Head>
